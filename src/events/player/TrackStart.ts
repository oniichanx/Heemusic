...
function createButtonRow(dispatcher: Dispatcher, client: heemusic): ActionRowBuilder<ButtonBuilder> {
...
function createCollector(message: any, dispatcher: Dispatcher, _track: Song, embed: any, client: heemusic, locale: string): void {
