...
function neb(embed: EmbedBuilder, player: Dispatcher, client: heemusic, locale: string): EmbedBuilder {
...
async function updateSetup(client: heemusic, guild: any, locale: string): Promise<void> {
